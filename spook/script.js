...
class evghost{
	constructor(type = Math.ceil(Math.random()*2.05), x = 0, y = 0, tx = 0, ty = 0, doe = 0){
		this.type = type;
		this.ix = x;
		this.iy = y;
		this.tx = tx;
		...
		this.ele;
		this.doe = doe;
		this.html = `<img src="https://ceuthyn.github.io/owop-eventscripts/spook/img/ghost${this.type}.png" class="ghort" id="${this.id}" style="left: -50; top: -50; opacity: 1;">`;
